...
from views.metals import create_metal, delete_metal, get_all_metals, get_single_metal, update_metal
from views.orders import create_order, delete_order, get_all_orders, get_single_order, update_order
from views.sizes import create_size, delete_size, get_all_sizes, get_single_size, update_size
from views.styles import create_style, delete_style, get_all_styles, get_single_style, update_style
